...
echo ""
echo -e "  ${ARROW} Server commands:"
echo -e "    ${DIM}sudo systemctl status ${SERVICE_NAME}${RESET}   ${DIM}— check server status${RESET}"
echo -e "    ${DIM}sudo systemctl stop ${SERVICE_NAME}${RESET}     ${DIM}— stop the server${RESET}"
echo -e "    ${DIM}sudo systemctl start ${SERVICE_NAME}${RESET}    ${DIM}— start the server${RESET}"
echo -e "    ${DIM}sudo systemctl restart ${SERVICE_NAME}${RESET}  ${DIM}— restart the server${RESET}"
echo -e "    ${DIM}sudo journalctl -u ${SERVICE_NAME} -f${RESET}  ${DIM}— view live logs${RESET}"
echo ""
